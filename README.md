...
![Architecture Comparison](Our%20Models/Images/Screenshot%202026-02-01%20at%2011.46.47%20PM.png)

![Model Performance](Our%20Models/Images/Screenshot%202026-02-01%20at%2011.46.57%20PM.png)
...
![Training Dynamics](Our%20Models/Images/Screenshot%202026-02-01%20at%2011.47.07%20PM.png)

![Sample Outputs](Our%20Models/Images/Screenshot%202026-02-01%20at%2011.47.15%20PM.png)
...
- No direct comparison on identical datasets (compute constraints)
- ConceptNet noise (antonym-heavy triples) not filtered
- DAQUAR evaluation limited to 10 epochs
- Performance degrades on complex spatial reasoning

## Citation

Based on the paper: *Revisiting KRISP: A Lightweight Reproduction and Analysis of Knowledge-Enhanced Vision-Language Models* (arXiv:2511.20795)

Original KRISP: Marino et al., "KRISP: Integrating implicit and symbolic knowledge for open-domain VQA", Facebook AI Research, 2020.
